...
<head>
<meta charset="UTF-8" />
<link rel="stylesheet" href="css/masongram.min.css">
<link rel="stylesheet"
...
<body>
	...
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/masonry/4.1.1/masonry.pkgd.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/jquery.imagesloaded/4.1.1/imagesloaded.pkgd.min.js"></script>
	<script async defer src="https://buttons.github.io/buttons.js"></script>
	<script src="js/masongram.min.js"></script>
	<script>
	...
	<br/>
		...
		<div class="masongram-container" style="position: relative; height: 2360px;">
			...
			<div tabindex="0" class="masongram-image-container masongram-image-size-standard_resolution"
				...
				<img src="Images/todolist.jpg" class="masongram-image">
					...
					<div class="masongram-image-caption">
						<div class="text-center">
							...
							<a tabindex="-1" class="btn btn-primary " href="#"> <i
								class="fas fa-id-card-alt"></i> 개인정보
							</a> <a tabindex="-1" class="btn btn-primary" href="#"> <i
			...
			<div tabindex="0"
				...
				<img src="Images/babyfeet.jpg" class="masongram-image" width="640"
					height="800">
				<div class="masongram-image-caption-container">
					<div class="masongram-image-caption">
						<div class="text-center">
			...
			<div tabindex="0"
				...
				<img src="Images/slanted.jpg" class="masongram-image" width="640"
					height="800">
				<div class="masongram-image-caption-container">
			...
			<div tabindex="0"
				class="masongram-image-container masongram-image-size-standard_resolution"
				style="position: absolute; left: 5%; top: 13.9%;">
				<img src="Images/doclookingforinfo.jpg" class="masongram-image">
				<div class="masongram-image-caption-container">
					<div class="masongram-image-caption">
						<div class="text-center">
							<p>
			...
			<div tabindex="0"
				class="masongram-image-container masongram-image-size-standard_resolution"
				style="position: absolute; left: 35%; top: 13.9%;">
				<img src="Images/stet.jpg" class="masongram-image">
				<div class="masongram-image-caption-container">
					<div class="masongram-image-caption">
						<div class="text-center">
							<p>
			...
			<div tabindex="0"
				class="masongram-image-container masongram-image-size-standard_resolution"
				style="position: absolute; left: 65%; top: 13.9%;">
				<img src="Images/sayingbubble.jpg" class="masongram-image">
				<div class="masongram-image-caption-container">
					<div class="masongram-image-caption">
						<div class="text-center">
							<p>
