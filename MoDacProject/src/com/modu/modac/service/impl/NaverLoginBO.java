...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "kZTeZSK7xvqzpnXZcuau";       //네이버API Client ID
    private final static String CLIENT_SECRET = "H5M2S98s4p";                      
    private final static String REDIRECT_URI = "http://localhost:8080/MoDacProject/naverlogincallback.do";
