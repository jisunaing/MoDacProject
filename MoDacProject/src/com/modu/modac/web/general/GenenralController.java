...
public class GenenralController {
	...
	public String selfdiagnosis_eye(HttpServletRequest req) throws Exception {
		String method = req.getMethod();

		if (method.equals("POST")) { req.setAttribute("selfresult", "selfresult");	}

		return "general/diagnosis/Self_diagnosis_Eyes.tiles";
	}// 눈

	@RequestMapping("/general/diagnosis/self_diagnosis_mouth.do")
	public String selfdiagnosis_mouth(HttpServletRequest req) throws Exception {
		String method = req.getMethod();
	...
	public String selfdiagnosis_neck(HttpServletRequest req) throws Exception {
		String method = req.getMethod();
	...
	public String selfdiagnosis_nose(HttpServletRequest req) throws Exception {
		String method = req.getMethod();
	...
	public String selfdiagnosis_brain(HttpServletRequest req) throws Exception {
	...
	public String selfdiagnosis_ear(HttpServletRequest req) throws Exception {
